...
class BeautyTextfield extends StatefulWidget {
  ...
  final dynamic width, height, wordSpacing;
  final dynamic backgroundColor, accentColor, textColor;
  final dynamic placeholder, fontFamily;
  final dynamic prefixIcon, suffixIcon;
  final dynamic inputType;
  final dynamic margin;
  final dynamic duration;
  final dynamic onClickSuffix;
  final dynamic textBaseline;
  final dynamic fontStyle;
  final dynamic fontWeight;
  final dynamic autofocus, autocorrect, enabled, obscureText, isShadow;
  final dynamic focusNode;
  final dynamic maxLength, minLines, maxLines;
  ...
  const BeautyTextfield(
      ...
      this.textColor = const Color.fromARGB(255, 9, 94, 30),
